...
def create_app(safety, device_manager, sqlitedb, timedb, system_monitor, broadcast_service):
    app = FastAPI()
    services.set_dependencies(safety, device_manager, sqlitedb, timedb, system_monitor, broadcast_service)
...
def test_nodes_endpoints_use_query_params(tmp_path):
    ...
    app = create_app(safety, device_manager, sqlitedb, timedb, system_monitor, broadcast_service)
