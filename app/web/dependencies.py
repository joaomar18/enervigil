...
class HTTPDependencies:
    ...
    Attributes:
        ...
        broadcast_service (BroadcastService | None): Broadcast service for real-time data with SSE.
    """
    ...
    def set_dependencies(
        ...
        Args:
            ...
            broadcast_service: BroadcastService instance for real-time data with SSE
        """
        self.safety = safety
        self.device_manager = device_manager
        self.db = db
    ...
    def get_broadcast_service(self) -> BroadcastService:
        """
        Get the BroadcastService service instance.

        Returns:
            BroadcastService: Configured broadcast service for real-time data with SSE

        Raises:
            ValueError: If BroadcastService has not been initialized
        """
        if self.broadcast_service:
            return self.broadcast_service
        raise ValueError("Broadcast Service is not yet initialized in HTTP Dependencies")
